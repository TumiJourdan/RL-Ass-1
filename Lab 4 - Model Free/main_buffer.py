...
def sarsa(num_episodes, env:gym.Env, gamma, alpha,decay_rate, eps):
    ...
    for episode in range(num_episodes):
        ...
        plt.imshow(V.reshape(4,12), cmap='autumn', interpolation='nearest')
        buf = io.BytesIO()
    ...
    imageio.mimsave('heatmaps.gif', images, duration=20)
    return list
...
rewards = sarsa(200,env,gamma,alpha,decay_rate,eps)
