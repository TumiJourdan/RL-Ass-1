...
class CurriculumCallback(BaseCallback):
    ...
    # custom on step to use correct actions for learning stage
...
class Gym2OpEnv(gym.Env):
    ...
    def setup_observations(self):
        # normalised and reduced observations
        obs_attr_to_keep = [
            "rho",
            "line_status",
            "topo_vect",
...
def main():
    ...
    model = A2C("MultiInputPolicy", env=env, verbose=1, tensorboard_log=f"runs/{run.id}",learning_rate=1e-3,
