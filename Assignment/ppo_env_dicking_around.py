...
def main():
    ...
    ppo_change_bus = PPO(policy='MultiInputPolicy', env=env_change_bus_egent,policy_kwargs=policy_kwargs, verbose=1, tensorboard_log="runs/change_bus",)
    ppo_change_line_status = PPO(policy='MultiInputPolicy', env=env_change_line_status_agent,policy_kwargs=policy_kwargs, verbose=1, tensorboard_log="runs/change_line",)
    ppo_curtail = PPO(policy='MultiInputPolicy', env=env_curtail_agent,policy_kwargs=policy_kwargs, verbose=1, tensorboard_log="runs/curtail",)
    ppo_redispatch = PPO(policy='MultiInputPolicy', env=env_redispatch_agent, verbose=1,policy_kwargs=policy_kwargs, tensorboard_log="runs/redispatch",)
